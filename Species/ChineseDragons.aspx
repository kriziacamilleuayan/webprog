<%@ Page Title="Species" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="ChineseDragons.aspx.cs" Inherits="ChineseDragons" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron parallax" style="background-image:url(../images/drag5.jpg); background-size:cover; padding-bottom: 0; padding-left: 0px; padding-top: 0px; margin-bottom: 15px;"> 
       ...
       <div class="container">
              <div class="border">
                    <h3 style="color:white">Chinese Dragons</h3>
              </div>

         <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-8">
              <p><b><span class="red">Lung Yu (Jade Dragon)</span></b></p>
              <p  style="color: #999999">Fast moving lightweight couriers. Primarily green, these dragons are small enough in size to stand eye to eye with humans. Possess long delicate looking wings that taper and nearly reach the ground. Capable of fast and high-level travel, flying 120 miles (190 km) in two hours with an average of 60 mph. Do not have riders, unlike Western courier dragons, because of their exceptional intelligence.</p>
              <br />
              <p><b><span class="red">Emerald Glass</span></b></p>
              <p  style="color: #999999">These dragons tend to enter the military. They are green with red markings and typically slow-witted, compared to other Chinese breeds, noted for intelligence.</p>
          </div>
          <div class="col-sm-12 col-md-12 col-lg-4 text-right">
          <p>
            <img src="~/images/species/drag7.jpg" runat="server" class="img-responsive" />
               <p class="text-center" style="color: lightyellow">Jade Dragon, by Shyangell</p>
            </p>
          </div>
        </div>
       ...
       <div class="row">
          <div class="col-sm-12">
              <p><b><span class="red">Scarlet Flower</span></b></p>
              <p  style="color: #999999">Another dragon that tends to enter the military due to an aggressive temperament. As their name implies, they are bright red.</p>
              <br />
              <p><b><span class="red">Shen Lung (Broadwinged)</span></b></p>
              <p  style="color: #999999">An experimental breed of lightweight dragon used for inter-continental travel, their albatross-like wings, stretching to well over twice their own body length, are comparable in size to those of heavyweight dragons, if not larger.</p>
          </div>
        </div>
...
In Throne of Jade, Temeraire is said to be 20 ft shorter and half the weight of Maximus, an incredibly large Regal Copper. He is later stated to be 20 tons, making Maximus 40. If a 50-ton regal is 120 ft, then Maximus must be 111 ft. This puts Temeraire at about 90 ft, bigger than most dragons though still slightly smaller than other older Celestials, He is still dwarfed by a few larger heavyweights such as Regal Coppers, which ordinarily range between 26-30 tons.</p>
          ...
          <div class="col-sm-12 col-md-12 col-lg-4 text-right">
          <p>
            <img src="~/images/species/drag9.jpg" runat="server" class="img-responsive" />
               <p class="text-center" style="color: lightyellow">Celestial Dragon, by Kalia</p>
            </p>
          </div>
        </div>
       ...
       <div class="row">
         <div class="col-sm-12 col-md-12 col-lg-4 text-right">
          <p>
            <img src="~/images/species/drag10.jpg" runat="server" class="img-responsive" />
               <p class="text-center" style="color: lightyellow">Spiritual Dragon, by Drummergirl375</p>
            </p>
          </div>
          <div class="col-sm-12 col-md-12 col-lg-8">
              <p><b><span class="red">Shen Lung (Spiritual Dragon)</span></b></p>
              <p  style="color: #999999">The Shen-lung was an extremely common breed of dragon. Many superior Chinese dragons originated from this breed, in a design similar to the British Yellow Reaper. Their appearance and size varied greatly, but their blue-grey coloring seemed to be their main common point.
