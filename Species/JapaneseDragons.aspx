<%@ Page Title="Species" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="JapaneseDragons.aspx.cs" Inherits="JapaneseDragons" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron parallax" style="background-image:url(../images/drag5.jpg); background-size:cover; padding-bottom: 0; padding-left: 0px; padding-top: 0px;"> 
       ...
       <div class="container">
              <div class="border">
                    <h3 style="color:white">Japanese Dragons</h3>
              </div>
